...
ListNode* pp_merge2Lists(ListNode* l1, ListNode* l2){
...
ListNode* pp_mergeKLists(vector<ListNode*> lists){
    // Dummy Node + Heap
    if (lists.size() == 0){
        return nullptr;
    }
...
int main(){
    ...
    ListNode* result = pp_merge2Lists(list1, list2);
